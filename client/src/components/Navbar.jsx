                    ...
                    <div className="hidden md:flex items-center gap-8">
                        {isAuthenticated ? (
                            <>
                                ...
                                <Link to="/create-course" className="text-gray-600 hover:text-gray-900 font-medium transition-colors">
                                    Create Channel
                                </Link>
                                ...
                                {user?.role === 'admin' && (
                                    <Link to="/admin/dashboard" className="text-red-600 hover:text-red-900 font-medium transition-colors">
                                        Admin Panel
                                    </Link>
                                )}
