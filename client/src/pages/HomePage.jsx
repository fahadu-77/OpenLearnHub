...
const HomePage = () => {
  ...
  if (isAuthenticated) {
    if (role === "student") {
      ...
      ctaLink = "/create-course";
      ctaText = "Spread Knowledge";
    }
  }
        ...
        <div className="container mx-auto px-4 py-24 md:py-32">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl md:text-2xl text-gray-500 mb-12 max-w-2xl mx-auto animate-slide-up-delay">
              Explore thousands of creative courses. Build skills with
              expert-led classes.
            </p>
            ...
            {CATEGORIES.map((category, index) => (
              ...
              >
                ...
                >
                  ...
                  {/* Category Name */}
                  <h3
                    className={`text-lg font-semibold ${category.text} mb-2 leading-snug min-h-[3rem]`}
                  >
                    {category.name}
                  </h3>
